...
Scenario Outline: : Creación de multas Monto fijo Casos (124240)
	...
	Examples: 
		...
		|Automatizadas QA DOS	|Pruebas auto |8-Concepto TUAV  | 1-Generar Tasa Anual Vehicular CCVH 	 |Monto fijo|590		|3000		|Especifico|590  |AUTOBUS	  | CRUZ ROJA | Valle 	   | Alianza |	
...
Scenario Outline: : Creación de multas Porcentaje Casos(124500) (124470)
	...
	Examples: 
		...
		|Pruebas porcentaje |Pruebas descr|8-Concepto TUAV  | 1-Generar Tasa Anual Vehicular CCVH 	 |Porcentaje|9		   |Valor del vehículo|Mayor o igual a|78	|20000		|20000		|Especifico|20000	 |AUTOBUS	  | CRUZ ROJA | Valle 	   | Alianza |
