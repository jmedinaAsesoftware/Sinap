...
public class ListasDesplegablesPages {
	...
	@FindBy(how = How.XPATH, using = "//mat-select[@formcontrolname = 'codigoConcepto']")
	private WebElement BtnListaConcepto;
	...
	@Step
	public void ListaConcepto(WebDriver driver, String Concepto) {

		clickOnElement(BtnListaConcepto);
		WebElement concepto = driver.findElement(By.xpath("//span[contains(text(),'" + Concepto + "')]"));
		concepto.click();
		questions.impliciWait();
	}
	...
	@Step
	public void ListaTipoPlacas() {
		
		clickOnElement(BtnListaTipoPlacas);
		WebElement tipoPlaca = driver.findElement(By.xpath("//span//mat-option-text[contains(text(),'\" + TipoPlaca + \"')]"));
		tipoPlaca.click();
		questions.impliciWait();
